        ...
        switch (v.getId())
        {
            case R.id.button:
                ...
                else
                {
                    registros = base.rawQuery("SELECT * FROM alumnos",null);
                    boolean sw = true;
                    Cursor registrosVerificacion = base.rawQuery("SELECT * FROM alumnos WHERE id="+id_input,null);
            ...
            case R.id.button3:
                ...
                String telefono_input2 = t_telefono.getText().toString();

                if(id_input2.equals("") || nombre_input2.equals("")
                        || dni_input2.equals("") || telefono_input2.equals(""))
                {
                    Context c = getApplicationContext();
            ...
            case R.id.button4:
                ...
                {
                    Context c = getApplicationContext();
                    String m = "El id que intenta eliminar esta en blanco.";
                    Toast.makeText(c,m,Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    {
                        Context c = getApplicationContext();
                        String m = "El id que intenta eliminar no existe.";
                        Toast.makeText(c,m,Toast.LENGTH_LONG).show();
                    }
                }
